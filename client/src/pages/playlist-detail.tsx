...
import { Loader2, MoreVertical, Play, Music4, ArrowLeft } from "lucide-react";
      ...
      <div className="max-w-3xl mx-auto px-4 md:px-10 py-4 mb-16 flex flex-col gap-5">
        <div className="flex items-start justify-between gap-3">
          <div className="flex items-center gap-2">
            ...
            >
              <ArrowLeft className="w-10 h-10" size={48}/>
            </Button> */}
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button
                  variant="ghost"
                  size="icon"
                  className="text-white/80 hover:bg-white/10 hover:text-white rounded-full mr-1"
                >
        ...
        <div className="flex justify-between items-center -mt-4">
          ...
          <Button
            ...
            variant="ghost"
            onClick={() => setLocation("/playlists")}
            className="p-4 text-white hover:bg-white/10 hover:text-white "
          >
